...
Connect your FormBold form to Mailchimp to automatically sync form submissions with your Mailchimp audience.
...
- Mapping your form fields to Mailchimp fields using the Field Mapper


**Step 5**: Submit a test form and check Mailchimp to confirm the sync.